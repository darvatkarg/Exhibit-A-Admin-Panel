      ...
      <Row>
        <Col md={12}>
          <Col md={12}>
            <Breadcrumb>
              <BreadcrumbItem>
                <Link to={"/auditorList"}>auditor</Link>
              </BreadcrumbItem>
              {update === true ? (
                <BreadcrumbItem active>Add auditor</BreadcrumbItem>
              ) : (
                <BreadcrumbItem active>Edit auditor</BreadcrumbItem>
              )}
            </Breadcrumb>
          </Col>
          <Card>
            <CardBody>
              <Form>
                <h2>
                  {update === true ? <b>Add auditor</b> : <b>Edit auditor</b>}
                </h2>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        name="phoneNumber"
                        placeholder="Enter Auditor Phone Number"
                        required
                      />
                      <span
                        style={{
