...
export function MixedWidget1({ className }) {
  ...
  const downloadFile = () => {
    window.location.href =
      "https://katechnologiesgh.s3.eu-central-1.amazonaws.com/KATon_admin_V2.0.exe";
  };
      ...
      <div className="card-body p-0 position-relative overflow-hidden">
        <div className="card-spacer ">
          <div className="row">
                      ...
                      <div class="col bg-light-danger px-6 py-8 rounded-xl">
                        ...
                        <div className="d-flex justify-content-between">
                          <a class="text-danger font-weight-bold font-size-h6 mt-2">
                            Number of Teachers Reading Book
                          </a>
                          <a
            ...
            <div class="col-lg-6 col-xxl-3 col-md-6">
            ...
            <div class="col-lg-3 col-xxl-3">
              <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                <div class="card-body p-0 position-relative bg-white rounded overflow-hidden">
                  ...
                  <div class="card-spacer d-flex justify-content-center align-items-center h-100 ">
                    <div class=" m-0">
                      <div className="font_blue">Desktop Application</div>
                      <br></br>
                      <div className="font_grey">
                        Download .exe installable on Windows Machine
                      </div>
                      <br></br>
                      <div className="font_grey">Version 1.5</div>
                      <br></br>
